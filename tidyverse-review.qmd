---
title: "Tidyverse and ggplot2 Review: Reproducing Ecological Findings Using a Case Study of Hawksbill Turtle Nesting" # Title of documnet
...
## Why ggplot Matters
The package ggplot2 is used for creating visualizations based on the grammar of graphics.
This means plots are built in layers:
...
table.2 = turtles.clean |>
  ...
  summarize(
    mean.ccl = mean(`Curved Carapace Length`, na.rm = TRUE), #na.rm = T gets rid of NAs
