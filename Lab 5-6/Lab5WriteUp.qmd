...
Virus counts in the nucleus vary across CellType and SampleType, with differences in central tendency (mean and median) suggesting condition-dependent infection levels. The variability within groups (SD and IQR) indicates heterogeneous infection across cells, consistent with the broad distributions observed in the violin plots.
